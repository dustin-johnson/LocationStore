...
(function($) {
    $.prompt = function(message, options) {
        ...
        $.each(message,function(statename,stateobj){
                ...
                states += '<div id="'+ $.prompt.options.prefix +'state_'+ statename +'" class="'+ $.prompt.options.prefix + 'state" style="display:none;">'+ arrow + title;
                if (stateobj.html != '')
                    states +='<div class="'+ $.prompt.options.prefix +'message">' + stateobj.html +'</div>';
                states +='<div class="'+ $.prompt.options.prefix +'buttons">';
